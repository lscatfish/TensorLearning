...
fig1.savefig("iris/mt_results/01_data_exploration.png", dpi=150, bbox_inches="tight")
plt.close(fig1)
...
fig2.savefig("iris/mt_results/02_decision_boundaries.png", dpi=150, bbox_inches="tight")
plt.close(fig2)
...
fig3.savefig("iris/mt_results/03_logistic_regression.png", dpi=150, bbox_inches="tight")
plt.close(fig3)
...
fig4.savefig("iris/mt_results/04_svm.png", dpi=150, bbox_inches="tight")
plt.close(fig4)
...
fig5.savefig("iris/mt_results/05_random_forest.png", dpi=150, bbox_inches="tight")
plt.close(fig5)
...
fig6.savefig("iris/mt_results/06_knn_mt_nn.png", dpi=150, bbox_inches="tight")
plt.close(fig6)
...
fig7.tight_layout()
fig7.savefig("iris/mt_results/07_summary.png", dpi=150, bbox_inches="tight")
plt.close(fig7)

print("  图表已保存至 iris/mt_results/ 目录:")
